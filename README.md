...
This project is for Axon Vision home test assignment.
...
```
git clone https://github.com/savra0923/AxonVision.git
cd video_pipeline
```
2. Install required packages (see above).
3. Make sure you have a video file in instructions/ (default: People - 6387.mp4).
...
|---------------|---------|-----------------------------------------------------------|---------|
| --video       | -v      | Path to the input video file                               | instructions/People - 6387.mp4 |
